...
function finkom_scripts() {
  ...
  wp_enqueue_style( 'finkom-fonts', get_template_directory_uri() . '/assets/fonts/fonts.css', array(), '1.0.0' );
	...
	wp_enqueue_script( 'finkom-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'finkom-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
